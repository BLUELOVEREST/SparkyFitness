...
import {
  ...
  SafeKitchen,
  SafeMealPlanTemplates,
  SafeMealPlanTemplateForm,
  SafeWorkoutPlanTemplates,
  SafeWorkoutPlanTemplateForm,
  SafeFoodDetail,
  SafeMealDetail,
  SafeExerciseDetail,
...
function AppContent() {
  ...
  const { shouldYieldObserverSync } = useAutoSyncOnOpen({
    initialRoute,
    syncMutation,
  });
        ...
        <LightboxProvider>
          ...
          <Stack.Navigator
            ...
            screenOptions={{
              ...
              headerTintColor:
                Platform.OS === 'android' ? textPrimary : undefined,
            }}
          ...
          >
            ...
            <Stack.Screen
              ...
              options={({ route }) =>
                createStackScreenOptions(
                  route.params.familyUser.displayName.trim() ||
            ...
            <Stack.Screen
              ...
              options={({ route }) =>
                createStackScreenOptions(route.params.mealTypeName, {
                  headerBackButtonDisplayMode: 'minimal',
                })
              }
            />
            ...
            <Stack.Screen
              ...
              options={createStackScreenOptions(
                t('screens.foods', { defaultValue: 'Foods' }),
                {
            ...
            <Stack.Screen
              ...
              options={createStackScreenOptions(
                t('screens.meals', { defaultValue: 'Meals' }),
                {
                  headerBackTitle: t('navigation.library', {
                    defaultValue: 'Library',
                  }),
            ...
            <Stack.Screen
              ...
              options={createStackScreenOptions(
                t('screens.exercises', { defaultValue: 'Exercises' }),
                {
                  headerBackTitle: t('navigation.library', {
                    defaultValue: 'Library',
                  }),
            ...
            <Stack.Screen
              ...
              options={createStackScreenOptions(
                t('libraryPlans.kitchen', { defaultValue: 'Kitchen' }),
                {
                  headerBackTitle: t('navigation.library', {
                    defaultValue: 'Library',
                  }),
            ...
            <Stack.Screen
              ...
              options={createStackScreenOptions(
                t('libraryPlans.mealPlans', { defaultValue: 'Meal Plans' }),
                {
                  headerBackTitle: t('navigation.library', {
                    defaultValue: 'Library',
                  }),
            ...
            <Stack.Screen
              ...
              options={createStackScreenOptions(
                ...
                {
                  headerBackTitle: t('libraryPlans.mealPlans', {
            ...
            <Stack.Screen
              ...
              options={createStackScreenOptions(
                t('workoutPlan.planNamePlaceholder', {
                  defaultValue: 'Training Focus Plan',
                }),
                {
                  headerBackTitle: t('libraryPlans.workoutPlans', {
                    defaultValue: 'Workout Plans',
                  }),
                },
              )}
            ...
            <Stack.Screen
              ...
              options={({ route }) =>
                createStackScreenOptions(
                  route.params.updatedPreset?.name ?? route.params.preset.name,
                  {
                    headerBackTitle: t('navigation.presets', {
            ...
            <Stack.Screen
              ...
              options={({ route }) =>
                createStackScreenOptions(
                  route.params.updatedItem?.name ?? route.params.item.name,
                  {
                    headerBackTitle: t('screens.foods', {
                      defaultValue: 'Foods',
                    }),
                  },
                )
            ...
            <Stack.Screen
              ...
              options={createStackScreenOptions(
                t('screens.meal', { defaultValue: 'Meal' }),
                {
                  headerBackTitle: t('screens.meals', {
                    defaultValue: 'Meals',
                  }),
                },
              )}
            ...
            <Stack.Screen
              ...
              options={createStackScreenOptions(
                t('screens.addFood', { defaultValue: 'Add Food' }),
                {
            ...
            <Stack.Screen
              ...
              options={({ route }) =>
                createStackScreenOptions(route.params.item.name, {
                  presentation: 'modal',
                  ...(Platform.OS === 'android' ? androidModalAnimation : {}),
                })
              }
            ...
            <Stack.Screen
              ...
              options={createStackScreenOptions(
                t('screens.barcodes', { defaultValue: 'Barcodes' }),
                {
              ...
              options={({ route }) =>
                createStackScreenOptions(
                  route.params.mode === 'edit-exercise'
                    ? t('screens.editExercise', {
                        defaultValue: 'Edit Exercise',
                      })
                    : t('screens.newExercise', {
              ...
              options={({ route }) =>
                createStackScreenOptions(
                  route.params.mode === 'edit-preset'
                    ? t('screens.editPreset', { defaultValue: 'Edit Preset' })
                    : t('screens.newPreset', { defaultValue: 'New Preset' }),
                  {
                    presentation: 'modal',
                    ...(Platform.OS === 'android' ? androidModalAnimation : {}),
                  },
            ...
            <Stack.Screen
              ...
              options={createStackScreenOptions(
                t('screens.scanFood', { defaultValue: 'Scan Food' }),
                {
                  presentation: 'modal',
                  ...(Platform.OS === 'android' ? androidModalAnimation : {}),
                },
            ...
            <Stack.Screen
              ...
              options={createStackScreenOptions(
                t('screens.photoFood', { defaultValue: 'Photo Food' }),
                {
                  presentation: 'modal',
                  ...(Platform.OS === 'android' ? androidModalAnimation : {}),
                },
            ...
            <Stack.Screen
              ...
              component={SafeChat}
              options={createStackScreenOptions(
                t('screens.sparky', { defaultValue: 'Sparky' }),
                { headerBackButtonDisplayMode: 'minimal' },
              )}
            />
            <Stack.Screen
              ...
              options={({ route }) =>
                createStackScreenOptions(
                  route.params?.mode === 'edit'
                    ? t('screens.editMeal', { defaultValue: 'Edit Meal' })
                    : t('screens.createMeal', { defaultValue: 'Create Meal' }),
                  {
                    presentation: 'modal',
                    ...(Platform.OS === 'android' ? androidModalAnimation : {}),
                  },
            ...
            <Stack.Screen
              ...
              options={({ route }) =>
                createStackScreenOptions(
                  route.params.entry.food_name ??
                    t('screens.foodEntry', { defaultValue: 'Food Entry' }),
                  {
            ...
            <Stack.Screen
              ...
              options={createStackScreenOptions(
                t('screens.trends', { defaultValue: 'Trends' }),
                {
                  headerBackTitle: t('navigation.details', {
              ...
              options={({ route }) =>
                createStackScreenOptions(
                  route.params?.session
                    ? t('screens.editWorkout', { defaultValue: 'Edit Workout' })
            ...
            <Stack.Screen
              ...
              options={({ route }) =>
                createStackScreenOptions(
                  route.params?.entry
                    ? t('screens.editActivity', {
                        defaultValue: 'Edit Activity',
                      })
                    : t('screens.newActivity', {
            ...
            <Stack.Screen
              ...
              options={({ route }) =>
                createStackScreenOptions(
                  route.params?.session?.name ??
                    t('screens.workout', { defaultValue: 'Workout' }),
                  {
                    headerBackTitle: t('navigation.diary', {
                      defaultValue: 'Diary',
                    }),
            ...
            <Stack.Screen
              ...
              options={({ route }) =>
                createStackScreenOptions(
                  route.params.session.name ??
                    t('screens.activity', { defaultValue: 'Activity' }),
                  {
                    headerBackTitle: t('navigation.diary', {
                      defaultValue: 'Diary',
                    }),
            ...
            <Stack.Screen
              ...
              component={SafeLogs}
              options={createStackScreenOptions(
                t('screens.logs', { defaultValue: 'Logs' }),
                {
                  headerBackTitle: t('navigation.settings', {
                    defaultValue: 'Settings',
                  }),
            ...
            <Stack.Screen
              ...
              component={SafeSync}
              options={createStackScreenOptions(
                t('screens.healthSync', { defaultValue: 'Health Sync' }),
                {
                  headerBackTitle: t('navigation.settings', {
                    defaultValue: 'Settings',
                  }),
            ...
            <Stack.Screen
              ...
              options={createStackScreenOptions(
                t('screens.importHistory', { defaultValue: 'Import History' }),
                {
                  headerBackTitle: t('screens.healthSync', {
                    defaultValue: 'Health Sync',
                  }),
                },
              )}
            />
            <Stack.Screen
              ...
              options={createStackScreenOptions(
                t('screens.measurements', { defaultValue: 'Measurements' }),
                {
                  presentation: 'modal',
                  ...(Platform.OS === 'android' ? androidModalAnimation : {}),
                },
            ...
            <Stack.Screen
              ...
              options={createStackScreenOptions(
                t('screens.calorieSettings', {
                  defaultValue: 'Calorie Settings',
                }),
                {
                  headerBackTitle: t('navigation.settings', {
                    defaultValue: 'Settings',
            ...
            <Stack.Screen
              ...
              options={createStackScreenOptions(
                t('screens.foodSettings', { defaultValue: 'Food Settings' }),
                {
                  headerBackTitle: t('navigation.settings', {
                    defaultValue: 'Settings',
                  }),
            ...
            <Stack.Screen
              ...
              options={createStackScreenOptions(
                t('screens.mealTypes', { defaultValue: 'Meal Types' }),
                {
                  headerBackTitle: t('navigation.settings', {
                    defaultValue: 'Settings',
                  }),
            ...
            <Stack.Screen
              ...
              options={createStackScreenOptions(
                t('screens.diarySettings', { defaultValue: 'Diary Settings' }),
                {
                  headerBackTitle: t('navigation.settings', {
                    defaultValue: 'Settings',
                  }),
            ...
            <Stack.Screen
              ...
              options={createStackScreenOptions(
                t('screens.serverSettings', {
                  defaultValue: 'Server Settings',
                }),
                {
                  headerBackTitle: t('navigation.settings', {
                    defaultValue: 'Settings',
            ...
            <Stack.Screen
              ...
              options={createStackScreenOptions(
                t('screens.passkeys', { defaultValue: 'Passkeys' }),
                {
                  headerBackTitle: t('navigation.settings', {
                    defaultValue: 'Settings',
                  }),
            ...
            <Stack.Screen
              ...
              options={createStackScreenOptions(
                t('settings.app', { defaultValue: 'App Settings' }),
                {
                  headerBackTitle: t('navigation.settings', {
                    defaultValue: 'Settings',
                  }),
            ...
            <Stack.Screen
              ...
              options={createStackScreenOptions(
                ...
                {
                  headerBackTitle: t('settings.app', {
            ...
            <Stack.Screen
              ...
              component={SafeAbout}
              options={createStackScreenOptions(
                t('screens.about', { defaultValue: 'About' }),
                {
                  headerBackTitle: t('navigation.settings', {
                    defaultValue: 'Settings',
                  }),
            ...
            <Stack.Screen
              ...
              options={createStackScreenOptions(
                t('screens.whatsNew', { defaultValue: "What's New" }),
                {
                  headerBackTitle: t('navigation.settings', {
                    defaultValue: 'Settings',
                  }),
            ...
            <Stack.Screen
              ...
              options={createStackScreenOptions(
                t('screens.cycleSetup', { defaultValue: 'Cycle Setup' }),
                {
                  presentation: 'modal',
                  headerBackButtonDisplayMode: 'minimal',
                  ...(Platform.OS === 'android' ? androidModalAnimation : {}),
            ...
            <Stack.Screen
              ...
              options={createStackScreenOptions(
                t('screens.wellnessHub', { defaultValue: 'Wellness Hub' }),
                {
            ...
            <Stack.Screen
              ...
              options={createStackScreenOptions(
                t('screens.logDailyEntry', { defaultValue: 'Log Daily Entry' }),
                {
                  presentation: 'modal',
                  headerBackButtonDisplayMode: 'minimal',
                  ...(Platform.OS === 'android' ? androidModalAnimation : {}),
            ...
            <Stack.Screen
              ...
              options={createStackScreenOptions(
                t('screens.pregnancySetup', {
                  defaultValue: 'Pregnancy Setup',
                }),
                {
                  presentation: 'modal',
                  headerBackButtonDisplayMode: 'minimal',
