...
import type {
  ActiveMealPlanDayMeal,
  MealPlanTemplate as LegacyMealPlanTemplate,
} from './mealPlan';
...
import type {
  ...
  MealPlanTemplate as MealPlansTemplate,
} from './mealPlans';
...
export type RootStackParamList = {
  ...
  MealPlans: undefined;
  MealPlanForm: { template?: MealPlansTemplate; initialMeal?: Meal } | undefined;
  ...
  MealPlanTemplateForm:
    | { mode: 'create' }
    | { mode: 'edit'; template: LegacyMealPlanTemplate };
