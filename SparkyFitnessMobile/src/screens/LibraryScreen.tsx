    ...
    >
      ...
      <View className="bg-surface rounded-xl mb-6 shadow-sm overflow-hidden">
        ...
        >
          ...
          <View className="flex-row items-center">
            <Text className="text-text-secondary text-base mr-2">
              {t('libraryPlans.kitchenSubtitle', {
                defaultValue: 'Plan preview',
              })}
            </Text>
            <Icon name="chevron-forward" size={20} color="#999" />
          </View>
        ...
        >
          ...
          <View className="flex-row items-center">
            <Text className="text-text-secondary text-base mr-2">
              {t('libraryPlans.mealPlansSubtitle', {
                defaultValue: 'Weekly templates',
              })}
            </Text>
            <Icon name="chevron-forward" size={20} color="#999" />
          </View>
        ...
        >
          <Text className="text-base font-semibold text-text-primary">
            {t('libraryPlans.workoutPlans', { defaultValue: 'Workout Plans' })}
          </Text>
          <View className="flex-row items-center">
            <Text className="text-text-secondary text-base mr-2">
              {t('libraryPlans.workoutPlansSubtitle', {
