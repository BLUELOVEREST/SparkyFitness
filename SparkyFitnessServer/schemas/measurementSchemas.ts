...
export const UpsertCheckInBodySchema = z
  .object({
    ...
    shoulders: nullableOptionalLegacyNumber,
    chest: nullableOptionalLegacyNumber,
    abdomen: nullableOptionalLegacyNumber,
    left_biceps: nullableOptionalLegacyNumber,
    right_biceps: nullableOptionalLegacyNumber,
    left_thigh: nullableOptionalLegacyNumber,
    right_thigh: nullableOptionalLegacyNumber,
    left_calf: nullableOptionalLegacyNumber,
    right_calf: nullableOptionalLegacyNumber,
