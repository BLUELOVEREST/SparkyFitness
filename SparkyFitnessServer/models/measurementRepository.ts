    ...
    const result = await client.query(
      `WITH latest_entry AS (
       ...
       SELECT
         ...
         (SELECT shoulders FROM check_in_measurements WHERE user_id = $1 AND entry_date <= $2 AND shoulders IS NOT NULL AND shoulders > 0 ORDER BY entry_date DESC LIMIT 1) as shoulders,
         (SELECT chest FROM check_in_measurements WHERE user_id = $1 AND entry_date <= $2 AND chest IS NOT NULL AND chest > 0 ORDER BY entry_date DESC LIMIT 1) as chest,
         (SELECT abdomen FROM check_in_measurements WHERE user_id = $1 AND entry_date <= $2 AND abdomen IS NOT NULL AND abdomen > 0 ORDER BY entry_date DESC LIMIT 1) as abdomen,
         (SELECT left_biceps FROM check_in_measurements WHERE user_id = $1 AND entry_date <= $2 AND left_biceps IS NOT NULL AND left_biceps > 0 ORDER BY entry_date DESC LIMIT 1) as left_biceps,
         (SELECT right_biceps FROM check_in_measurements WHERE user_id = $1 AND entry_date <= $2 AND right_biceps IS NOT NULL AND right_biceps > 0 ORDER BY entry_date DESC LIMIT 1) as right_biceps,
         (SELECT left_thigh FROM check_in_measurements WHERE user_id = $1 AND entry_date <= $2 AND left_thigh IS NOT NULL AND left_thigh > 0 ORDER BY entry_date DESC LIMIT 1) as left_thigh,
         (SELECT right_thigh FROM check_in_measurements WHERE user_id = $1 AND entry_date <= $2 AND right_thigh IS NOT NULL AND right_thigh > 0 ORDER BY entry_date DESC LIMIT 1) as right_thigh,
         (SELECT left_calf FROM check_in_measurements WHERE user_id = $1 AND entry_date <= $2 AND left_calf IS NOT NULL AND left_calf > 0 ORDER BY entry_date DESC LIMIT 1) as left_calf,
         (SELECT right_calf FROM check_in_measurements WHERE user_id = $1 AND entry_date <= $2 AND right_calf IS NOT NULL AND right_calf > 0 ORDER BY entry_date DESC LIMIT 1) as right_calf,
  ...
  try {
    const result = await client.query(
      `SELECT 
         ...
         (SELECT shoulders FROM check_in_measurements WHERE user_id = $1 AND shoulders IS NOT NULL ORDER BY entry_date DESC LIMIT 1) as shoulders,
         (SELECT chest FROM check_in_measurements WHERE user_id = $1 AND chest IS NOT NULL ORDER BY entry_date DESC LIMIT 1) as chest,
         (SELECT abdomen FROM check_in_measurements WHERE user_id = $1 AND abdomen IS NOT NULL ORDER BY entry_date DESC LIMIT 1) as abdomen,
         (SELECT left_biceps FROM check_in_measurements WHERE user_id = $1 AND left_biceps IS NOT NULL ORDER BY entry_date DESC LIMIT 1) as left_biceps,
         (SELECT right_biceps FROM check_in_measurements WHERE user_id = $1 AND right_biceps IS NOT NULL ORDER BY entry_date DESC LIMIT 1) as right_biceps,
         (SELECT left_thigh FROM check_in_measurements WHERE user_id = $1 AND left_thigh IS NOT NULL ORDER BY entry_date DESC LIMIT 1) as left_thigh,
         (SELECT right_thigh FROM check_in_measurements WHERE user_id = $1 AND right_thigh IS NOT NULL ORDER BY entry_date DESC LIMIT 1) as right_thigh,
         (SELECT left_calf FROM check_in_measurements WHERE user_id = $1 AND left_calf IS NOT NULL ORDER BY entry_date DESC LIMIT 1) as left_calf,
         (SELECT right_calf FROM check_in_measurements WHERE user_id = $1 AND right_calf IS NOT NULL ORDER BY entry_date DESC LIMIT 1) as right_calf,
